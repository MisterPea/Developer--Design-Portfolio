...
import aboutImageBASE64 from '../app/aboutImageData';

export default function AboutImageCanvas( { darkMode, color = "#000000" } ) {
  ...
  function addImage( img ) {
    ...
    onCtx.clip();
    canvasDivRef.current.appendChild( onCanvas );
  ...
  return (
    <div ref={canvasDivRef} className="canvas-wrapper" />
  );
}
